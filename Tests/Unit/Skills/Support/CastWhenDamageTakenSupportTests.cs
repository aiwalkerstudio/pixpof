...
namespace Game.Tests.Unit.Skills.Support
{
    ...
    public class CastWhenDamageTakenSupportTests
    {
        ...
        [Test]
        public void CanLinkSkill_WithValidActiveSkill_ShouldReturnTrue()
        {
            // Arrange
            var activeSkill = new Fireball();

            // Act
            bool canLink = _support.LinkSkill(activeSkill);
        ...
        [Test]
        public void CanLinkSkill_WithReservationSkill_ShouldReturnFalse()
        {
            // Arrange
            _mockActiveSkill.Setup(s => s.HasReservation).Returns(true);

            // Act
            bool canLink = _support.LinkSkill(_mockActiveSkill.Object);
